[[ if $pagetype == 'visitorpage' ]][[* if you want visitors to be able to login or register remove this redirect *]]
...
<div id="content">
    <div id="main">
        ...
        [[ else ]]
            ...
            [[ content ]][[* for example a tag list or visitorpage if no redirect *]]
            </div>
        [[ /if ]]
    </div><!-- #main -->
