...
<html xmlns="http://www.w3.org/1999/xhtml" [[lang type='xml']] [[lang type='html']]><head>
    ...
    <link href="[[ template_dir ]]garden.css" title="Garden" rel="stylesheet" type="text/css" media="screen" />

    [[ if $pagetype=="page" ]]
    
<link rel="stylesheet" type="text/css" href="[[ $paths.site_url ]]gbcf-v3/files/themes/gardenform.css" media="screen" />
    <!--[if IE]>
