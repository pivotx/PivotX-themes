...
<head>
 ...
 <script type="text/javascript" src="[[template_dir]]jquery/jquery.gallerax-0.2.1.js"></script>
<!-- select here the desired css in relation to the type of gallery you are using -->
 <link href="[[template_dir]]gallery03.css" rel="stylesheet" type="text/css" media="screen" />
