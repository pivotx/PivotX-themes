...
<div class="commentform">
	...
	<div class="commentform_row">	
		...
		[[ emotpopup ]] :: [[ register_as_visitor_link ]]  [[ textilepopup ]]   <br />     
		<a id="respond"></a>
	...
	<div class="privacy_options">
		<div class="commentform_row">	
			...
			<label for="piv_rememberinfo">[[t]]Remember me on this computer.[[/t]]</label>
		</div>
	
		<div class="commentform_row">
			<input name="piv_notify" type="checkbox" id="piv_notify" value="1" [[ remember name="notify"]] />
			<label for="piv_notify">[[t]]Send me email when someone replies.[[/t]]</label>
		</div>
			
		<div class="commentform_row">
			<input name="piv_discreet" type="checkbox" id="piv_discreet" value="1" [[ remember name="discreet"]] />
			<label for="piv_discreet">[[t]]Hide my email address.[[/t]]</label> 
		</div>
	</div>
				
	<div class="commentform_row">	
		<small>[[t escape="no"]]<strong>Small print:</strong><br />All HTML tags except &lt;b&gt; and &lt;i&gt; will be removed from your comment.<br />You can make links by just typing the url or mail-address.[[/t]]</small>
	</div>
...
$().ready(function() {
	...
	$("#commentform").validate({
		...
		messages: {
			piv_name: "Please enter your name",
