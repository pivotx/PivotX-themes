...
<div class="postholder">
		...
		[[ tags ]]
        <br />
       <p style="text-align: right;"><img src="[[template_dir]]images/arrow.gif" width="7" height="7" />[[ more ]] &nbsp; &nbsp; <img src="[[template_dir]]images/arrow.gif" width="7" height="7" /> [[ commentlink ]]</p>
